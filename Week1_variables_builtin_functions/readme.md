<div align="center">
  <h1>IISO PC Class 2024/2025</h1>
</div>

<p align="center">
<img src="../learn-python.jpeg" />
</p>

<div align="center">
<sub>Teacher:
<a href="https://www.linkedin.com/in/mrintj/" target="_blank">Abdulmalek Shefat</a><br>
<small> First Edition: April, 2024</small>
</sub>
<hr>
</div>

[Week 2: Operators >>](/Week2_Operators/02_operators.md)
...
- [📘 Week 1](#-week-1)
  ...
  - [Numbers](#numbers)
  - [💻 Exercises - Week 1](#-exercises---day-2)
...
![Built-in Functions](/Week1_variables_builtin_functions/imgs/builtin-functions.png)

Let us open the Python shell and start using some of the most common built-in functions.

![Built-in functions](/Week1_variables_builtin_functions/imgs/builtin-functions_practice.png)

Let us practice more by using different built-in functions

![Help and Dir Built in Functions](/Week1_variables_builtin_functions/imgs/help_and_dir_builtin.png)
...
![Min Max Sum](/Week1_variables_builtin_functions/imgs/builtin-functional-final.png)
...
🌕 You are awesome. You have just completed Week #1 challenges and you are two steps ahead on your way to greatness. Now do some exercises for your brain and muscles.
...
2. Write a python comment saying 'Week 1: IISO PC Class 2024/2025'
